                ...
                <div className='flex flex-col md:flex-col w-[15em] gap-5 mt-[-1em] '>
                    <fieldset className='flex flex-col gap-3 border border-1 border-orange-300 w-full py-2 p-2'>
                        ...
                        <div>
                            ...
                            <label htmlFor="Technology" className='p-2 text-black  font-bold text-[20px]'>Fruit</label>
                        </div>
                        <div className='flex'>
                            <input className='border border-orange-700 border-1' type="number" id="price" onChange={(e) => setPrice(e.target.value)} />
